...
class DataFile:
    ...
    @property
    def partition(self) -> list[PrimitiveLiteral | None]: ...
    @property
...
class ManifestFile:
    ...
    @property
    def partitions(self) -> list[FieldSummary]: ...
    @property
    def key_metadata(self) -> bytes | None: ...


class ManifestList:
    def entries(self) -> list[ManifestFile]: ...


def read_manifest_entries(bs: bytes) -> Manifest: ...
def read_manifest_list(bs: bytes) -> ManifestList: ...
